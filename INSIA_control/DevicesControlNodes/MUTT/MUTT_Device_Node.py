...
import rclpy
from insia_msg.msg import StringStamped, BoolStamped, ControladorFloat, FloatStamped
...
class MUTT_Node(Node):
    ...
    def __init__(self):
        super().__init__(node_name='ThrottleNode',
        ...
        self._set_range(self.get_parameter('throttle_range').value)
        ...
        self.pub_enable_throttle = self.create_publisher(msg_type=BoolStamped, topic='Enable',
                                                         qos_profile=HistoryPolicy.KEEP_LAST)

        self.pub_target = self.create_publisher(msg_type=FloatStamped, topic='Target',
                                                qos_profile=HistoryPolicy.KEEP_LAST)
    ...
    def _set_range(self, range: float):
        self.device_range(-range, range)
