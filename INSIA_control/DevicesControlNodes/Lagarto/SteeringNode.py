...
class SteeringNode(Node):
    ...
    def __init__(self):
        ...
        self.pub_enable = self.create_publisher(msg_type=BoolStamped, topic='EPOS_Volante/Enable',
                                                qos_profile=HistoryPolicy.KEEP_LAST)

        self.pub_enable_steering = self.create_publisher(msg_type=EPOSDigital, topic='EPOS_Volante/Digital',
                                                         qos_profile=HistoryPolicy.KEEP_LAST)

        self.pub_target = self.create_publisher(msg_type=EPOSConsigna, topic='EPOS_Volante/TargetPosition',
                                                qos_profile=HistoryPolicy.KEEP_LAST)
