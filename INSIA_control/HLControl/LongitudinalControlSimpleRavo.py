...
class LongitudinalController(Node):
    ...
    def __init__(self):
        ...
        self.speed_limit = vehicle_parameters['speed']['limit_speed']
    ...
    def telemetry_callback(self, msg: Telemetry):
        ...
        if self.target is not None:
            target_speed = interp(min(self.target.speed, self.speed_limit), self.speed_range, [0, 1])
            ...
            if accel_signal > brake_signal:
                ...
                accel_signal = 0
            if self.target.speed == 0 and msg.speed < 1.5:
